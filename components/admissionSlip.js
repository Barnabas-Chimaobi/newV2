...
import { ADMISSION_LETTER } from '../pages/api/queries/applicant';
import Loader from "./loadingpage";

export default function AdmissionSlip(applicationForm) {
    ...
    const admissionletterFunc = async (appNo) => {
        try {
            ...
            setDetails(admissionResponse?.data?.admissionLetterDetails);
            setloading(false);
        } catch (error) {
                                                ...
                                                <div className='col-4'>
                                                    <div
                                                        ...
                                                        <QRCode
                                                            ...
                                                            value={Constant.BASE_URL + `/common/admissionslip/` + applicationForm}
                                                            viewBox={`0 0 256 256`}
                                                        />
                                                    </div>
