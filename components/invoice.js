...
export default function Invoice({ invoiceNumber }) {
	console.log(invoiceNumber, "invoiuce===number====");
							...
							<div className="row justify-content-center">
								<div className="col-xl-10">
												...
												<div className="row">
													<div className="col-lg-4 col-md-4">
														<div className="invoice-issues-date">
															<p>
																Session : {details?.feeDetail?.session?.name}{" "}
															</p>
														</div>
													</div>
													<div className="col-lg-4 col-md-4">
									...
									<div className="pb-4 mb-5" id="printButton">
										...
										{details?.paystackRedirectUrl === null ? (
											<></>
										) : (
											<div className="col-auto text-end float-end ms-auto download-grp">
												<a
													href={details?.paystackRedirectUrl}
