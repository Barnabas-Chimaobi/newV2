                            ...
                            <div className="row justify-content-center">
                                <div className="col-xl-10">
                                    ...
                                    <div className='pb-4 mb-5' id='printButton'>
                                        ...
                                        {details?.paystackRedirectUrl === null ? <></> : <div className='col-auto text-end float-end ms-auto download-grp'>
                                            <a href={details?.paystackRedirectUrl} class="btn btn-outline-primary me-2" target='_blank'><i class="fas fa-credit-card" >
                                            </i> Pay With Card</a>
                                        </div>}
                                    </div>
