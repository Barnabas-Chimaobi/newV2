...
export default function Receipt({ invoiceNumber }) {
    ...
    const [receipt, { loading: receiptLoad, error: receiptError, data: receiptData }] = useLazyQuery(RECEIPT)
                                ...
                                <div className="col-xl-10">
                                        ...
                                        <div className="card-body">
                                                ...
                                                <div className="row justify-space-between">
                                                    <div className="col-12 col-lg-6">
                                                        <div className="invoice-info">
                                                            ...
                                                            <h6 className="invoice-name"> <span className='invoice-details invoice-details-two'>Matric Number:</span> {details?.matricNumber}</h6>
                                                            <h6 className="invoice-name"> <span className='invoice-details invoice-details-two'>Department:</span> {details?.departmentName} </h6>
                                                            <h6 className="invoice-name"> <span className='invoice-details invoice-details-two'>School:</span> {details?.facultyName} </h6>
                                                        </div>
                                                    </div>
                                                    <div className="col-12 col-lg-6 float-end">
                                                        <div className="invoice-info">
                                                            {/* <strong className="customer-text-one">Billed to</strong> */}
                                                            <h6 className="invoice-name"><span className='invoice-details invoice-details-two'>RRR / CONFIRMATION:</span> </h6>
                                                            <h6 className="invoice-name"> <span className='invoice-details invoice-details-two'>PAYMENT MODE:</span> {details?.paymentMode?.payment_Mode_Name}</h6>
                                                            <h6 className="invoice-name"> <span className='invoice-details invoice-details-two'>PAYMENT TYPE:</span> {details?.paymentType?.paymentTypeName} </h6>
                                            ...
                                            <div className="invoice-issues-box">
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-4 col-md-4">
                                                        <div className="invoice-issues-date">
                                                            <p>Date Paid : {new Date(details?.datePaid).toLocaleDateString()}  </p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                                    ...
                                                                    </tr> */}
                                                                    {
                                                                        details?.feeDetail?.fees.map((item, index) => (
                                                                            <tr>
                                                                                ...
                                                                                <td className='ml-'>{parseInt(index) + 1}</td>
                                                                                <td >{NairaFormatter(item?.amount)}</td>
                                                                                <td className="text-end">{NairaFormatter(item?.amount)}</td>
                                                                            </tr>
                                                                        ))
                                                                    }
                                                                </tbody>
                                                    ...
                                                    <div className="invoice-total-card">
                                                        <div className="invoice-total-box">
                                                            ...
                                                            <div className="invoice-total-footer">
                                                                <h4>
                                                                    Total Amount <span> {NairaFormatter(details?.total)}</span>
                                                                </h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div className='d-flex justify-content-between'>
                                                <div
                                                    ...
                                                    <QRCode
                                                        ...
                                                        value={Encrypt(Constant.BASE_URL + `/common/receipt/` + details?.invoiceNumber)}
                                                        viewBox={`0 0 256 256`}
                                                    />
                                                </div>
                                                <div className='mb-5'>
                                    ...
                                    <div className='pb-4 mb-5'>
                                        <div className='col-auto text-end float-end ms-auto download-grp' onClick={() => print()} id='printButton'>
                                            <a href="#" class="btn btn-outline-primary me-2"><i class="fas fa-download" ></i>Print Receipt</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
