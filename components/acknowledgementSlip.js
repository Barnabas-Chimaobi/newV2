...
export default function AcknowledgementSlip({ data }) {
	...
	const [
		Acknowledgement,
		{
			loading: AcknowledgementLoad,
			error: AcknowledgementError,
			data: AcknowledgementData,
		},
	] = useLazyQuery(ACKNOWLEDGEMENTPAGE);
								...
								<div className="card invoice-info-card">
									<div className="card-body">
										<div className="invoice-item invoice-item-one">
											...
											<div className="invoice-head mb-4">
												<h2 className="text-center">
													{details?.sessionName} Acknowledgement Slip
												</h2>
											</div>
										...
										{details?.fieldGroupForPages.map((item, x) => {
											if (
												!(
													item?.pageName.includes("O-Level") ||
										...
										<div className="invoice-item invoice-item-one"></div>
										<div className="row mx-auto">
														...
														<div className="col-6 p-3">
															<div className="p-4">
																<h6 className="fw-bold">
																	{x == 0 ? "First Sitting" : "Second Sitting"}
																</h6>
															</div>
															<div className="p-4">
																<h6>Exam Number</h6>
															...
															<div className="p-4">
																<div className="">
																	<table>
																		...
																		<tbody>
																			{item?.olevelResultCombinationDetails?.map(
																				(val, x) => {
																					return (
																						<tr>
																							<td>{val?.subject}</td>
								...
								<div className="pb-4 mb-5" id="printButton">
									<div
										...
										<a href="#" class="btn btn-outline-primary me-2">
											<i class="fas fa-download"></i> Print Acknowledgement Slip
										</a>
									</div>
								</div>
							</div>
