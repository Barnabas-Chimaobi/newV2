...
export default function Programme() {
  ...
  const [
    saveprogrammeItem,
    {
      loading: saveprogrammeItemLoading,
      error: saveprogrammeItemError,
      data: saveprogrammeItemData,
    },
  ...
  const [
    deleteprogramme,
    { loading: delLoad, error: delError, data: delData },
  ...
  const saveprogramme = async (data) => {
    ...
    try {
      const response = await saveprogrammeItem({
        variables: {
          name: data?.Name,
