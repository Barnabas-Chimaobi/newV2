...
export const UPDATE_DEPARTMENT = gql`
  mutation updateDepartment($id: Int!, $name: String!, $facultyId: Int!) {
    updateDepartment(id: $id, name: $name, facultyId: $facultyId) {
      id
      name
    }
  }
...
export const UPDATE_FACULTY = gql`
  mutation updateFaculty($name: String!, $id: Int!, $description: String!) {
    updateFaculty(name: $name, id: $id, description: $description) {
      name
      id
    }
  }
...
export const SAVE_COURSE_BULK = gql`
  mutation SaveCourseBulk($model: [BulkCourseUploadDtoInput!]!) {
    saveCourseBulk(model: $model) {
      courseName
      courseCode
      status
    }
